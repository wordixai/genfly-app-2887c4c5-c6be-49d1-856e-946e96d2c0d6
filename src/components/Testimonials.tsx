...
const testimonials = [
  {
    ...
    content: "Brew Haven is my go-to spot for both work and relaxation. The atmosphere is perfect, and their cappuccino is the best in town!",
    rating: 5,
  ...
  },
  {
    name: "Michael Chen",
    role: "Food Blogger",
    content: "I've visited cafes all over the city, and Brew Haven stands out for its exceptional coffee quality and friendly service. Their pastries are baked fresh daily and absolutely delicious.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Local Artist",
    content: "As someone who spends hours sketching in cafes, I appreciate Brew Haven's comfortable seating and ambient lighting. The staff never rushes you, and they remember your usual order.",
    rating: 4,
