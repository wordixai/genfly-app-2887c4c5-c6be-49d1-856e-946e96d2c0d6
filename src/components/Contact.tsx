      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            We'd love to see you! Drop by for a coffee or get in touch with us.
          </p>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <MapPin className="w-6 h-6 text-amber-800 mr-4 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold mb-1">Address</h4>
                    <p className="text-gray-600">123 Coffee Street, Brewville, CA 94123</p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <Phone className="w-6 h-6 text-amber-800 mr-4 mt-1 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start">
                  <Mail className="w-6 h-6 text-amber-800 mr-4 mt-1 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start">
                  <Clock className="w-6 h-6 text-amber-800 mr-4 mt-1 flex-shrink-0" />
                  <div>
